      ...
      <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            <li class="<?= $request->uri->getSegment(2) == "officialStore" ? "active" : ($request->uri->getSegment(2) == "category" ? "active" : ($request->uri->getSegment(2) == "product" ? "active" : ($request->uri->getSegment(2) == "reportOrder" ? "active" : ($request->uri->getSegment(2) == "configuration" ? "active" : ($request->uri->getSegment(2) == "courier" ? "active" : ""))))) ?>">
              <a href="#commerce" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="true"><i class="ri-store-2-line"></i><span>Commerce</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
              <ul id="commerce" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
