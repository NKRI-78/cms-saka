                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Edit Commerce Banner</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                        <div class="new-user-info">
                            <form enctype="multipart/form-data">
                                ...
                                <br><button type="button" onclick="UpdateCommerceBanner()" id="updateBanner" class="btn btn-custom" style="float: right;">Submit</button><br><br>
                            </form>
                        </div>
                    </div>
                </div>
